...
foreach ($data_kartu_keluarga as $kartu_keluarga) {
    ...
    $pdf->cell(50, 7, strtoupper($kartu_keluarga['nama_warga']), 1, 0, 'L');
    ...
    $pdf->cell(7, 7, strtoupper($kartu_keluarga['rt_warga']), 1, 0, 'C');
    $pdf->cell(7, 7, strtoupper($kartu_keluarga['rw_warga']), 1, 1, 'C');
