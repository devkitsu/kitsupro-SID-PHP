...
*/
	...
	$query= "INSERT INTO kartu_keluarga (id_keluarga, nomor_kk, id_kepala_keluarga, alamat_keluarga, id_user,
            created_at, updated_at) VALUES (NULL, '$nomor_keluarga', '$id_kepala_keluarga', '$alamat_keluarga',
