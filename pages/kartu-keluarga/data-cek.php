...
$query="SELECT warga.id_warga, warga.nik_warga, warga.nama_warga, kartu_keluarga.nomor_kk, kartu_keluarga.id_kepala_keluarga FROM warga JOIN kartu_keluarga WHERE kartu_keluarga.id_kepala_keluarga=warga.id_warga";
