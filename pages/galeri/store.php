...
if (in_array($file_ext,$allowed_file_types) && ($filesize < 200000))
{
	...
	if (file_exists("res/" . $newfilename))
	{
		// Jika file sudah ada
	...
	{
		move_uploaded_file($_FILES["file"]["tmp_name"], "res/" . $newfilename);
    ...
    // query
    $query = "INSERT INTO `galeri` (`id_galeri`, `nama_file`, `caption`)
            VALUES ('', '$path_galeri', '$caption_galeri');";
