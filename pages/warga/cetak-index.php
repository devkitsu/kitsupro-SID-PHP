...
class PDF extends FPDF
{
    ...
    function Header()
    {
      ...
      $this->Image('../../assets/img/kng.jpg',20,10);
    	...
    	// $this->Cell(60);
    	// Title
        $this->Cell(308,8,'PEMERINTAH KOTA TANGERANG SELATAN',0,1,'C');
        $this->Cell(308,8,'KECAMATAN SETU',0,1,'C');
    	$this->Cell(308,8,'KELURAHAN KADEMANGAN',0,1,'C');
    	// Line break
    	$this->Ln(5);
        ...
        $this->cell(70,7,'ALAMAT',1,0,'C');
        $this->cell(7,7,'RT',1,0,'C');
        $this->cell(7,7,'RW',1,0,'C');
        $this->cell(20,7,'AGAMA',1,0,'C');
        $this->cell(30,7,'KERJA',1,0,'C');
        $this->cell(20,7,'STATUS',1,1,'C');
...
foreach ($data_warga as $warga) {
    ...
    $pdf->cell(50, 7, substr(strtoupper($warga['nama_warga']),0 , 17), 1, 0, 'L');
    ...
    $pdf->cell(70, 7, substr(strtoupper($warga['alamat_warga']), 0, 20), 1, 0, 'L');
    ...
    $pdf->cell(30, 7, strtoupper($warga['pekerjaan_warga']), 1, 0, 'C');
    $pdf->cell(20, 7, strtoupper($warga['status_perkawinan']), 1, 1, 'C');
}
