...
<table class="table table-striped table-middle">
  <tr>
    <th width="20%">NIK</th>
    <td width="1%">:</td>
    <td><input type="text" class="form-control" name="nik_warga" value="<?php echo $data_warga[0]['nik_warga'] ?>" disabled="disabled"></td>
  </tr>
  <tr>
    <th>Nama Warga</th>
    <td>:</td>
  ...
  <tr>
    ...
    <td>
      <select class="form-control selectpicker" name="status_perkawinan" required>
        <option value="<?php echo $data_warga[0]['status_perkawinan'] ?>" selected><?php echo $data_warga[0]['status_perkawinan'] ?></option>
  ...
  <tr>
    <td>
      <select class="form-control selectpicker" name="status" required>
        <option value="<?php echo $data_warga[0]['status'] ?>" selected><?php echo $data_warga[0]['status'] ?></option>
