                        ...
                        <form role="form" method="post" action="../login/proses-login.php">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Nama Pengguna / NIK" name="username_user" type="username" required="" autofocus>
                                </div>
                                <div class="form-group">
                                ...
                                <input onClick="window.location.href='../../index.php'" class="btn btn-lg btn-primary btn-block" value="Home">
                                </fieldset>
                        </form>
                    </div>
                </div>
