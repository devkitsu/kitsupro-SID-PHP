                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div>
                                      <p align="right">Total ada <?php echo $jumlah_warga['total'] ?> data warga. <?php echo $jumlah_warga_l['total_l'] ?> di antaranya laki-laki, dan <?php echo $jumlah_warga_p['total_p'] ?> diantaranya perempuan. <br/>Warga di atas 17 tahun berjumlah <?php echo $jumlah_warga_ld_17['total_ld'] ?> orang, dan di bawah 17 tahun berjumlah <?php echo $jumlah_warga_kd_17['total_kd'] ?> orang.
                                      </p>
